...
export default function CategoryContainer({
          ...
          customComponent: {
            ...
            props: {
              ...
              handleToggle: () =>
                updateCategoryData({
                  type: {
                    value: type.value === 'expense' ? 'income' : 'expense',
                  },
                }),
              className: 'ml-auto',
    ...
    },
    {
      ...
      field: {
        ...
        modal: {
          ...
          state: {
            value: iconName,
            updateState: (newIconName) =>
              updateCategoryData({ iconName: newIconName }),
          },
        },
      },
    },
      ...
      field: {
        ...
        modal: {
          innerModal: {
            ...
            props: {
              colors: COLORS.ENTITIES.CATEGORY_COLORS,
          ...
          state: {
            ...
            updateState: (newColorCode) =>
              updateCategoryData({ color: newColorCode }),
          },
        },
      },
    },
  ...
  categoryDataConfig.forEach((option) => {
  ...
  function handleNameInputChange(e) {
    ...
    if (
      value === '' ||
      VALIDATION_RULES.CATEGORY.NAME.CLIENT_REGEX.test(value)
    ) {
