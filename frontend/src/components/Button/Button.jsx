...
export default function Button({
  ...
  const btnBase =
    'transition-[box-shadow,opacity] shadow focus:outline-none focus:ring'
  ...
  const btnSecondary =
    'font-semibold text-gray-dark border border-gray-dark focus:border-opacity-0 focus:ring-gray-dark'
  const colorPalettes = {
    primary: cn(
    ...
    dangerSecondary:
      'font-semibold bg-red-dark text-gray-light focus:ring-goldenrod',
  }
