...
export default function validateSignupCredentials(email, password, fullName) {
  ...
  if (
    ...
    throw new ValidationError(
      `Password length should be between ${VALIDATION_RULES.PASSWORD.MIN_LENGTH} and ${VALIDATION_RULES.PASSWORD.MAX_LENGTH} characters. Please try again`,
    )
  }

  if (!VALIDATION_RULES.PASSWORD.REGEX.test(password)) {
    throw new ValidationError(
      'The password should include at least 1 lowercase letter, 1 uppercase letter and 1 special character',
    )
  }
