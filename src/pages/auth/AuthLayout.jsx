...
export default function AuthLayout() {
  ...
  return (
    <>
      {logOutMsg && <p className="mt-12 text-lg text-green-light">{logOutMsg}</p>}
      
      <main 
        className="px-4 tab:px-10 h-screen w-screen max-w-[425px] tab:max-w-[1920px] flex flex-col tab:flex-row justify-center tab:items-center gap-12 text-center">
